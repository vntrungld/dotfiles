...
# ALIAS {{{
  ...
  #}}}
  # YAOURT ALIASES {{{
    alias yaoupg='yaourt -Sybu --aur --noconfirm'
    alias yaoin='yaourt -S --noconfirm'
    alias yaore='yaourt -R'
    alias yaoun='yaourt -Rcsn'
    alias yaodown='yaourt -Sw'
  # }}}
  # MULTIMEDIA {{{
...
export PATH=${PATH}:${HOME}/yappy/yappy1-deploy/bin
